 ...
 */
final class Version20191211162552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE name name VARCHAR(150) NULL, CHANGE roles roles JSON NULL COMMENT \'(DC2Type:json_array)\', CHANGE created_at created_at DATETIME NULL, CHANGE updated_at updated_at DATETIME NULL, CHANGE token token VARCHAR(255) NULL');
    }
